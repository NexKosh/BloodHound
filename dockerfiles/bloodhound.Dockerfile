...
# Package Bloodhound
################
FROM --platform=$BUILDPLATFORM gcr.io/distroless/static-debian11 AS bloodhound

# ARG SHARPHOUND_VERSION # These are not strictly necessary here if hound-builder is removed, but commenting for safety
# ARG AZUREHOUND_VERSION # These are not strictly necessary here if hound-builder is removed, but commenting for safety
